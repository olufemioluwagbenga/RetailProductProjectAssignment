...
using StockaProSSO.Auth.Extentions;
...
namespace StockaProSSO.Auth.Controllers
{
    [Authorize]
    ...
    public class AccountController : Controller
    {
        ...
        )
        {
            ...
            _account = accountService; //new AccountService(interaction, httpContextAccessor, schemeProvider, clientStore);
        }
